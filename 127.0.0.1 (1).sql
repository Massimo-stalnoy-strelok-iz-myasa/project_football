...
--
-- Хост: 127.0.0.1
-- Время создания: Май 14 2021 г., 00:24
...
--
-- База данных: `cakes_for_people`
--
CREATE DATABASE `cakes_for_people` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cakes_for_people`;
--
-- База данных: `football_bd`
--
CREATE DATABASE `football_bd` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `football_bd`;

-- --------------------------------------------------------

--
-- Структура таблицы `amplua`
--

CREATE TABLE IF NOT EXISTS `amplua` (
  `name_amplua` text NOT NULL,
  `id_amplua` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_amplua`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;

--
-- Дамп данных таблицы `amplua`
--

INSERT INTO `amplua` (`name_amplua`, `id_amplua`) VALUES
('Центральный нападающий', 1),
('Левый Вингер', 2),
('Правый Вингер', 3),
('Центральный атакующий полузащитник', 4),
('Правый полузащитник', 5),
('Центральный полузащитник', 6),
('Левый полузащитник', 7),
('Латераль', 8),
('Левый защитник', 9),
('Правый защитник', 10),
('Центральный защитник', 11),
('Голкипер', 12);
...
CREATE TABLE IF NOT EXISTS `championship` (
  `name_league` text NOT NULL,
  `dates` text NOT NULL,
  `id_country` int(11) NOT NULL,
  `id_championship` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `country` (
  `name_country` int(11) NOT NULL,
  `language` int(11) NOT NULL,
  `capital_city` int(11) NOT NULL,
...
--
-- Структура таблицы `football_player`
--
...
CREATE TABLE IF NOT EXISTS `football_player` (
  ...
  `id_amplua` int(11) NOT NULL,
  `id_team` int(11) NOT NULL,
  `id_footballplayer` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_footballplayer`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- Дамп данных таблицы `football_player`
--

INSERT INTO `football_player` (`name_surname`, `height`, `weight`, `id_amplua`, `id_team`, `id_footballplayer`) VALUES
('Криштиану Рунальду', '187 см', '84 кг', 0, 0, 1),
('Лионель Месси', '169 см', '68 кг', 0, 0, 2);
...
--
-- База данных: `help_people`
--
CREATE DATABASE `help_people` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `help_people`;
...
--
-- Структура таблицы `need_or_can_help`
--

CREATE TABLE IF NOT EXISTS `need_or_can_help` (
  `id_people` int(11) NOT NULL,
  `id_predmets` int(11) NOT NULL,
  `can_help` tinyint(1) NOT NULL COMMENT 'могу_помочь',
  `need_help` tinyint(1) NOT NULL COMMENT 'надо_помочь'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `people` (
  `id_people` int(11) NOT NULL AUTO_INCREMENT COMMENT 'номер пользователя',
  `login` varchar(32) NOT NULL COMMENT 'логин',
  `password` varchar(32) NOT NULL COMMENT 'пароль',
  `id_class` int(11) NOT NULL COMMENT 'класс',
  `mobile` bigint(11) NOT NULL COMMENT 'номер телефона',
  `inthernet` varchar(32) NOT NULL COMMENT 'соц-сеть',
...
INSERT INTO `people` (`id_people`, `login`, `password`, `id_class`, `mobile`, `inthernet`) VALUES
(1, 'people1', 'people', 0, 2147483647, 'people-people'),
(2, 'people1', 'people', 135489, 2147483647, 'people-people'),
(3, 'people1', 'people', 135489, 79031234567, 'people-people');
...
CREATE TABLE IF NOT EXISTS `predmets` (
  `id_predmets` int(11) NOT NULL AUTO_INCREMENT,
  `name_predmets` varchar(32) NOT NULL,
  PRIMARY KEY (`id_predmets`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
--
...
('def', 'football_bd', 'amplua', 'name_amplua', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'amplua', 'id_amplua', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'championship', 'name_league', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'championship', 'dates', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'championship', 'id_country', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'championship', 'id_championship', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'country', 'name_country', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'country', 'language', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'country', 'capital_city', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'country', 'id_country', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'name_surname', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'height', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'weight', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'id_amplua', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'id_team', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'football_player', 'id_footballplayer', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'results', 'result', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'results', 'id_team', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'results', 'id_championship', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'team', 'name_team', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'team', 'city', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'team', 'setup_date', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'team', 'id_team', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'football_bd', 'users', 'login', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'users', 'pass', 3, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'football_bd', 'users', 'name', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'help_people', 'class', 'id_class', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'help_people', 'class', 'class', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'help_people', 'need_or_can_help', 'id_people', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'help_people', 'need_or_can_help', 'id_predmets', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'help_people', 'need_or_can_help', 'can_help', 3, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', 'могу_помочь'),
('def', 'help_people', 'need_or_can_help', 'need_help', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', 'надо_помочь'),
('def', 'help_people', 'people', 'id_people', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', 'номер пользователя'),
('def', 'help_people', 'people', 'login', 2, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', 'логин'),
('def', 'help_people', 'people', 'password', 3, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', 'пароль'),
('def', 'help_people', 'people', 'id_class', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', 'класс'),
('def', 'help_people', 'people', 'mobile', 5, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(11)', '', '', 'select,insert,update,references', 'номер телефона'),
('def', 'help_people', 'people', 'inthernet', 6, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', 'соц-сеть'),
('def', 'help_people', 'predmets', 'id_predmets', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'help_people', 'predmets', 'name_predmets', 2, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
...
('def', 'web_dz', 'prikolnaya_tema', 'name', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'web_dz', 'prikolnaya_tema', 'surname', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'web_dz', 'prikolnaya_tema', 'id', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2792'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2579'),
('INNODB_BUFFER_POOL_PAGES_DATA', '171'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '46'),
('INNODB_BUFFER_POOL_PAGES_FREE', '8020'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1534'),
('INNODB_BUFFER_POOL_READS', '149'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '438'),
...
('INNODB_DATA_WRITTEN', '1551872'),
('INNODB_DBLWR_PAGES_WRITTEN', '46'),
('INNODB_DBLWR_WRITES', '2'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '72'),
('INNODB_LOG_WRITES', '15'),
('INNODB_OS_LOG_FSYNCS', '23'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '40448'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '2103'),
('UPTIME_SINCE_FLUSH_STATUS', '2103');
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'A:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'A:\\usr\\local\\mysql-5.5\\data\\MAX.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'A:\\usr\\local\\mysql-5.5\\data\\MAX.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'A:\\usr\\local\\mysql-5.5\\data\\MAX.err'),
...
('PLUGIN_DIR', 'A:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'A:\\usr\\local\\mysql-5.5\\data\\MAX-slow.log'),
...
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'amplua', 'id_amplua', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'championship', 'id_championship', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'country', 'id_country', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'football_player', 'id_footballplayer', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'team', 'id_team', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'PRIMARY', 'def', 'football_bd', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'football_bd', 'id', 'def', 'football_bd', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'help_people', 'PRIMARY', 'def', 'help_people', 'people', 'id_people', 1, NULL, NULL, NULL, NULL),
('def', 'help_people', 'PRIMARY', 'def', 'help_people', 'predmets', 'id_predmets', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2021-05-13 20:24:19', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'amplua', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'championship', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'country', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'football_player', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'results', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'team', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'football_bd', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2021-05-13 19:55:06', '2021-05-13 19:55:06', NULL, NULL, '', '', NULL),
('def', 'help_people', 'class', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'help_people', 'need_or_can_help', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'help_people', 'people', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
('def', 'help_people', 'predmets', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2021-05-13 19:50:24', NULL, NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 56, 56, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2021-04-08 16:01:29', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2021-04-01 17:17:23', NULL, NULL, '', '', NULL),
('def', 'web_dz', 'prikolnaya_tema', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2021-04-01 17:35:48', NULL, NULL, NULL, '', '', NULL);
...
(68, 'root', 'localhost:57581', 'help_people', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(67, 'root', 'localhost:57580', NULL, 'Sleep', 0, '', NULL);
...
('def', 'cakes_for_people', 'utf8', 'utf8_general_ci', NULL),
('def', 'football_bd', 'utf8', 'utf8_general_ci', NULL),
('def', 'help_people', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'utf8', 'utf8_general_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'phpmyadmin', 'utf8', 'utf8_bin', NULL),
('def', 'web_dz', 'utf8', 'utf8_general_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1765'),
('INNODB_BUFFER_POOL_READS', '149'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '438'),
('INNODB_DATA_FSYNCS', '28'),
...
('def', 'football_bd', 'amplua', 0, 'football_bd', 'PRIMARY', 1, 'id_amplua', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'championship', 0, 'football_bd', 'PRIMARY', 1, 'id_championship', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'country', 0, 'football_bd', 'PRIMARY', 1, 'id_country', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'football_player', 0, 'football_bd', 'PRIMARY', 1, 'id_footballplayer', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'team', 0, 'football_bd', 'PRIMARY', 1, 'id_team', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'users', 0, 'football_bd', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'football_bd', 'users', 0, 'football_bd', 'id', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'help_people', 'people', 0, 'help_people', 'PRIMARY', 1, 'id_people', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'help_people', 'predmets', 0, 'help_people', 'PRIMARY', 1, 'id_predmets', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2021-05-13 20:24:19', '2021-05-13 20:24:19', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2021-05-13 20:24:19', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'football_bd', 'amplua', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 9437184, 13, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'championship', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'country', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'football_player', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 9437184, 3, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'results', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'team', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'football_bd', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2021-05-13 19:55:06', '2021-05-13 19:55:06', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'help_people', 'class', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'help_people', 'need_or_can_help', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'help_people', 'people', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 9437184, 4, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'help_people', 'predmets', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2021-05-13 19:50:24', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 56, 56, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2021-04-08 16:01:29', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2021-04-01 17:17:23', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin'),
('def', 'web_dz', 'prikolnaya_tema', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 9437184, NULL, '2021-04-01 17:35:48', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'football_bd', 'PRIMARY', 'football_bd', 'amplua', 'PRIMARY KEY'),
('def', 'football_bd', 'PRIMARY', 'football_bd', 'championship', 'PRIMARY KEY'),
('def', 'football_bd', 'PRIMARY', 'football_bd', 'country', 'PRIMARY KEY'),
('def', 'football_bd', 'PRIMARY', 'football_bd', 'football_player', 'PRIMARY KEY'),
('def', 'football_bd', 'PRIMARY', 'football_bd', 'team', 'PRIMARY KEY'),
('def', 'football_bd', 'PRIMARY', 'football_bd', 'users', 'PRIMARY KEY'),
('def', 'football_bd', 'id', 'football_bd', 'users', 'UNIQUE'),
('def', 'help_people', 'PRIMARY', 'help_people', 'people', 'PRIMARY KEY'),
('def', 'help_people', 'PRIMARY', 'help_people', 'predmets', 'PRIMARY KEY'),
...
('root', '[{"db":"web_dz","table":"prikolnaya_tema"}]');
...
('root', '2021-04-01 17:17:23', '{"lang":"ru"}');
--
-- База данных: `web_dz`
--
CREATE DATABASE `web_dz` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `web_dz`;

-- --------------------------------------------------------

--
-- Структура таблицы `prikolnaya_tema`
--

CREATE TABLE IF NOT EXISTS `prikolnaya_tema` (
  `name` text NOT NULL,
...
--
-- Дамп данных таблицы `prikolnaya_tema`
--

INSERT INTO `prikolnaya_tema` (`name`, `surname`, `id`) VALUES
('Саша', 'Перцев', 'chert');
